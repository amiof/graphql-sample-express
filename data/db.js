const data = [
  ...
  },
  {
    ...
    recipe: [
      ...
      "For best results, set your Crock-Pot or slow cooker to low (for 4–6 hours' cooking). You could also use high (for 2–3 hours' cooking).",
      "Cook until the beef gets soft to the bite but doesn’t break up.",
  ...
  },
  {
    ...
    discount: 0,
    introduction:
      "This spicy, crunchy salad is the taste of Southeast Asia on a plate, made with shredded unripe green papaya and other local fruit and vegetables tossed in a delicious sweet and sour dressing of palm sugar, chilli peppers and lime juice. Originating from Laos, it’s also eaten throughout Vietnam, Cambodia and Thailand. Making a traditional some tam means lots of shredding and pounding with a pestle and mortar, but modern, less messy and time-consuming takes on the traditional dish abound. ",
    details: [
      { Cuisine: "Thai" },
      { "Recipe Type": "Main" },
      { Difficulty: "Medium" },
    ...
    ingredients: [
      ...
      "3 good-sized carrots, trimmed",
      "1 large or 2 smaller mangoes (opt for firmer ones, so not too ripe)",
      "1 garlic clove, chopped",
      "1 red chilli, deseeded and sliced lengthways",
      "0.5 tsp sea salt juice",
      "2 limes, zested",
      "1 tsp sugar or 2 teaspoons honey",
      "1 handful large fresh coriander leaves-",
    ],
    recipe: [
      ...
      "Peel one side of the mango using a vegetable peeler and then shave off long, thin slivers of the mango's flesh with the peeler, so it's similar in shape and texture to the courgettes and carrots. Continue around the whole of the mango until you've used most of it up. Save any remaining bits of mango for a fruit salad.",
      "Mix the courgettes, carrot and mango together with the garlic, chilli, salt, lime juice and zest, and sugar or honey. Set aside while you fry the fishcakes.",
      "Press each ball down into a little cake and fry in olive oil until golden on each side. Serve with the some tam salad and garnish with coriander leaves and crushed peanuts.",
    ],
  },
  {
    id: 15,
